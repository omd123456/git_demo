...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/MohuServlet">
            ...
            <samp><a href="JavaScript:void()" id="delt">批量删除</a></samp>
            <!--用户-->
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                    <th width="10%">全选<input type="checkbox" id="dd"></th>
                    <th width="10%">用户编码</th>
                    <th width="20%">用户名称</th>
                    <th width="10%">性别</th>
                    <th width="10%">年龄</th>
                   ...
                   <c:forEach var="user" items="${userList }" varStatus="status">
					<tr>
					    <td>
					    <input type="checkbox" value="${user.id}" class="tte" name="ccte">
					    </td>
						<td>
